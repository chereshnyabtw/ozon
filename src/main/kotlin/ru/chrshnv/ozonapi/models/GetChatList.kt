...
data class GetChatList(
	...
	data class GetChatListFilter(
		@get:JsonProperty("chat_status")
		val chatStatus: String = "Opened",

		@get:JsonProperty("unread_only")
	...
	data class GetChatListResponse(
		...
		data class Chat(
			...
			@get:JsonProperty("first_unread_message_id")
			val firstUnreadMessageID: String = "0",

			@get:JsonProperty("last_message_id")
			val lastMessageID: String = "0",

			@get:JsonProperty("unread_count")
