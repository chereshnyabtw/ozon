...
data class TurnoverResponse(
	...
	data class TurnoverItemCategory(
		...
		data class TurnoverItem (
			...
			@get:JsonProperty("stock_items_total")
			val stockItemsTotal: Int = 0,
